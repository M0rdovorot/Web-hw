...
class TagManager(models.Manager):
    ...
    def get_popular_tags(self):
        tags = self.alias(num_questions=django.db.models.Count('question')).order_by('-num_questions')
        return tags[0:10]
...
class ProfileManager(models.Manager):
    def get_active_users(self):
        users = self.alias(num_questions=django.db.models.Count('question'),    ).order_by('-num_questions')
        return users[0:5]
